<template>
  ...
  >
    <path d="M1007.20276,490.067h-519.506V193.71244h519.506Z" transform="translate(-190.79724 -185.44745)" fill="#fff" />
    <path
      ...
      fill="#cacaca"
    />
    <circle cx="564.64129" cy="163.33526" r="55.49268" fill="#1ddfa2" />
    <path
    ...
    <polygon points="389.541 18.891 293.899 18.891 293.899 0 389.541 0 398.982 9.446 389.541 18.891" fill="#1ddfa2" />
    <path
    ...
    <path
      ...
      fill="#2f2e41"
    />
    <circle cx="254.00773" cy="54.05886" r="26.34173" fill="#a0616a" />
    <path
